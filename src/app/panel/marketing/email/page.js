...
import { Mail, Send, Users, Sparkles, Tag, Gift } from "lucide-react";
...
export default function MarketingEmailPage() {
    ...
    const handleSubmit = async (values, { setSubmitting, resetForm }) => {
        try {
            // We use the notifications API but specifically for email-only marketing
            // In a real app, you might have a dedicated /api/marketing/email endpoint
            // For now, we reuse the notification infrastructure with the email=true flag
            // and special metadata for template rendering.
                ...
                <div className="lg:col-span-1">
                    <div className="sticky top-6">
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                            {/* Convert Formik Context to Preview would require accessing context here, or just basic mock */}
                            <PreviewCard />
                        </div>
...
// Simple component to show static preview structure (since we can't easily access formik state outside)
// In a real app we'd lift state up
            ...
            <div className="flex-1 overflow-y-auto p-4 bg-gray-50 dark:bg-black">
                <div className="max-w-sm mx-auto bg-white rounded-lg shadow-sm border overflow-hidden">
                    ...
                    <div className="p-6 text-center">
                        <div className="font-bold text-xl text-gray-900 mb-2">LT LogaTech</div>
                        <div className="h-px bg-gray-100 my-4"></div>
                        <h1 className="text-2xl font-bold text-gray-800 mb-4">Summer Sale!</h1>
                        <p className="text-gray-600 mb-6 text-sm leading-relaxed">
                            This is where your email content will appear. 
                            It supports rich text and will be formatted beautifully 
                            to match the LogaTech brand.
                        </p>
                        <button className="bg-indigo-600 text-white px-6 py-2 rounded-md font-medium text-sm">
                            Shop Now
                        </button>
                    </div>
